...
export default class MyPrayers extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
       prays: [
         {id: 0, 'prayName': 'Cầu mong cả gia đình sẽ bình an', 'type': 'love', 'prayTogether': 4, 'prayCount': 3},
         {id: 1, 'prayName': 'Cầu chúc em trai năm sau sẽ đỗ đại học', 'type': 'love', 'prayTogether': 5, 'prayCount': 10},
         {id: 2, 'prayName': 'Tôi sẽ có nhiều tiền', 'type': 'inlove', 'prayTogether': 11, 'prayCount': 5},
         {id: 3, 'prayName': 'Tôi sẽ sẽ không phải code xuyên đêm nữa', 'type': 'addict', 'prayTogether': 22, 'prayCount': 7},
       ],
       prayer: null,
       deletedPray: null
    }
    ...
    return (
      <View style={styles.textInputWrapper}>
        ...
        <TextInput
          ...
          placeholder='Thêm lời cầu nguyện...'
          value={prayer}
