      ...
      <View>
        ...
        <View style={styles.userWrapper}>
          <Image
            ...
            resizeMode={'contain'}
          />
          <Text style={styles.invitatorName}>{invitator.name} đã mời bạn cùng cầu khấn</Text>
        </View>
        ...
        <View style={styles.actionWrapper}>
          ...
          >
            <Text style={styles.accept}>Chấp nhận</Text>
          </TouchableOpacity>

          <TouchableOpacity
            style={styles.actionBtn}
          >
            <Text style={styles.actionTxt}>Sẽ suy nghĩ</Text>
          </TouchableOpacity>

          <TouchableOpacity
            style={styles.actionBtn}
          >
            <Text style={styles.actionTxt}>Không, cảm ơn</Text>
          </TouchableOpacity>
        </View>
      </View>
    )
